class Constants {
  ...
  //Myhot Spot url
  // static const String baseUrl = "http://192.168.225.80:3000/api";
  //MyAirtel url
  // static const String baseUrl = "http://192.168.1.179:3000/api";
  //MyMtn Mifi
  // static const String baseUrl = "http://192.168.0.187:3000/api";

  //Server Error
  static const String baseUrl = "https://writeapp-api.onrender.com/api";
  // AUTH
